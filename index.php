		...
		<div class="container">
			...
			<div id="horizontalTab">
				<ul class="resp-tabs-list" style="display: flex;">
					<li>
						<img src="images/anh.png" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="images/anh1.png" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="images/anh2.png" alt=" " class="img-responsive" />
					</li>
				</ul>
				<div class="resp-tabs-container">
						...
						<div class="col-md-6 team-Info-agileits">
							...
							<div class="social-bnr-agileits footer-icons-agileinfo">
								<ul class="social-icons3">
									<li><a href="https://www.facebook.com/yuta.duy" class="fa fa-facebook icon-border facebook"> </a></li>
					...
					<div class="tabs2">
						...
						<div class="col-md-6 team-Info-agileits">
							...
							<div class="social-bnr-agileits footer-icons-agileinfo">
								<ul class="social-icons3">
									<li><a href="https://www.facebook.com/Nguyen9Dung/" class="fa fa-facebook icon-border facebook"> </a></li>
									<li><a href="#" class="fa fa-twitter icon-border twitter"> </a></li>
									<li><a href="#" class="fa fa-google-plus icon-border googleplus"> </a></li>
									<li><a href="#" class="fa fa-rss icon-border rss"> </a></li>
								</ul>
		...
		<section class="contact-w3ls" id="contact">
			<div class="container">
				...
				<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
					...
					<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3723.8639311820666!2d105.74468687610292!3d21.03812978061353!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x313455e940879933%3A0xcf10b34e9f1a03df!2zVHLGsOG7nW5nIENhbyDEkeG6s25nIEZQVCBQb2x5dGVjaG5pYw!5e0!3m2!1svi!2s!4v1709730577781!5m2!1svi!2s" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
				</div>
				<div class="clearfix"></div>
			</div>
		</section>
